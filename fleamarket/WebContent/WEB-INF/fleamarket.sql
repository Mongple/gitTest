...
INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'abc', CRYPTPACK.ENCRYPT('123','abc'), '슈퍼맨', '1999/05/27', sysdate
, '010-7777-7777', 'babo@hunch.com', 'U', 1);

INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'bbb', CRYPTPACK.ENCRYPT('123','bbb'), '배트맨', '1994/11/11', sysdate
, '010-7777-7777', 'ggg@hunch.com', 'U', 2);

INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'1', CRYPTPACK.ENCRYPT('123','1'), '1', '1999/05/27', sysdate
, '010-7777-7777', 'babo@hunch.com', 'U', 1);

INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'2', CRYPTPACK.ENCRYPT('123','2'), '2', '1994/11/11', sysdate
, '010-7777-7777', 'ggg@hunch.com', 'U', 2);

INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'3', CRYPTPACK.ENCRYPT('123','3'), '3', '1999/05/27', sysdate
, '010-7777-7777', 'babo@hunch.com', 'U', 1);

INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'4', CRYPTPACK.ENCRYPT('123','4'), '4', '1994/11/11', sysdate
, '010-7777-7777', 'ggg@hunch.com', 'U', 2);

INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'5', CRYPTPACK.ENCRYPT('123','5'), '5', '1999/05/27', sysdate
, '010-7777-7777', 'babo@hunch.com', 'U', 1);

INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'6', CRYPTPACK.ENCRYPT('123','6'), '6', '1994/11/11', sysdate
, '010-7777-7777', 'ggg@hunch.com', 'U', 2);

INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'7', CRYPTPACK.ENCRYPT('123','7'), '7', '1994/11/11', sysdate
, '010-7777-7777', 'ggg@hunch.com', 'U', 2);

INSERT INTO MEMBER(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_BIRTH, MEM_DATE
            , MEM_PHONE, MEM_EMAIL, MEM_GRANT, MEM_BLACK)
VALUES((SELECT NVL(MAX(MEM_NO),0)+1 FROM MEMBER)
,'8', CRYPTPACK.ENCRYPT('123','8'), '8', '1994/11/11', sysdate
, '010-7777-7777', 'ggg@hunch.com', 'U', 2);
